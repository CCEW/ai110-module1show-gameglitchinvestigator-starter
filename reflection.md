...
Failed to give me the correct hints. When I guessed 1, it told me to go lower, which is impossible since 1 is the lowest possible number. The secret number was 95, but it told me to go higher when I guessed 50, which was also incorrect. When I clicked the new game button, it did not start a new game.
...
Yes. It gave brief descriptions of their purpose and what they were testing for. This helped me understand the tests better.
---

## 4. What did you learn about Streamlit and state?

- How would you explain Streamlit "reruns" and session state to a friend who has never used Streamlit?
After every interation with the app, streamlit reruns the code. This resets any variables not stored in session state. session state allows storing variables across reruns, to keep track of secret number and attempts.
...
I like writing tests to check AI's work. It helps verify that the code is correct.
- What is one thing you would do differently next time you work with AI on a coding task?
I would also try to understand the code generated by the AI better, rather than just accepting it and running it.
- In one or two sentences, describe how this project changed the way you think about AI generated code.
This project made me more aware of the importance of critically evaluating AI-generated code and not just accepting it at face value.